...
## inside the docker
npm run full-deploy-eth-amsterdam-demo
...
npx hardhat full-deploy-demo-mumbai --network mumbai; npx hardhat unpause --network mumbai; npx hardhat create-profile --network mumbai
